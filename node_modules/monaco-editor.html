...
<body style="background-color:black;" onload="requestCurrentPageStatus()">
    <input class="styleDark" type="text" id="fileName" placeholder="Script URL"
        style="height: 17px;width:100%;border:1px solid grey">
    ...
    <svg onclick="pickerGetScript()" style="position:absolute;top: 690px;left: 79%;width:24px;height:24px" viewBox="0 0 24 24">
    ...
    <input id="entityScriptCheckbox" checked=true; type="checkbox" onclick="chooseScriptType('script')"
        style="position:absolute;top: 681px;left: 83%;">
    <label for="entityScriptCheckbox" style="color: rgb(226, 226, 226); position:absolute;top: 681px;left: 85%;">Entity
        Script</label>

    <input id="serverScriptCheckbox" type="checkbox" onclick="chooseScriptType('serverScripts')"
        style="position:absolute;top: 701px;left: 83%;">
    <label for="serverScriptCheckbox" style="color: rgb(226, 226, 226); position:absolute;top: 701px;left: 85%;">Server
        Script</label>

    <p id="changeStyleButton" onclick="changeStyle()" style="position:absolute;top: 654px;left: 96%;font-size: 28px;">🌜
    </p>
    ...
    <script>
        ...
        function changeStyle() {
            if (styleDark) {
                styleDark = false;
                document.getElementById("changeStyleButton").innerHTML = "🌞";
